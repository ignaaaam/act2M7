...
<div class="credentials-box">
        <form action="#" class="credentials-form ml-4 mt-6 w-3/4 h-1/4 bg-indigo-700 rounded-lg" action="?url=Login">
        <h1 class="p-6 font-bold text-2xl text-white">Login</h1>
            ...
            <br>
            <button type="submit" class="flex mx-auto mt-2 mb-4 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg cursor-pointer border border-white-100 border-opacity-50">Login</button>
